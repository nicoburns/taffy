...
fn android_news_feed() {
    ...
    let node00000 = taffy.new_leaf(taffy::style::Style {
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 0f32,
        ..Default::default()
    });
    taffy.set_children(node00000, &[node000000]).unwrap();
    ...
    let node00001 = taffy.new_leaf(taffy::style::Style {
    ...
    taffy.set_children(node00001, &[node000010, node000011]).unwrap();
    ...
    taffy.set_children(node0000, &[node00000, node00001]).unwrap();
    let node000 = taffy.new_leaf(taffy::style::Style {
        flex_direction: taffy::style::FlexDirection::Column,
        align_content: Some(taffy::style::AlignContent::Stretch),
        ..Default::default()
    });
    taffy.set_children(node000, &[node0000]).unwrap();
    ...
    taffy.set_children(node00100, &[node001000]).unwrap();
    ...
    let node00101 = taffy.new_leaf(taffy::style::Style {
        flex_direction: taffy::style::FlexDirection::Column,
        align_content: Some(taffy::style::AlignContent::Stretch),
        flex_shrink: 1f32,
        margin: taffy::geometry::Rect {
    ...
    taffy.set_children(node00101, &[node001010, node001011]).unwrap();
    ...
    taffy.set_children(node0010, &[node00100, node00101]).unwrap();
