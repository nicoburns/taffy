...
use crate::node::Node;
use crate::style::{FlexboxLayout, GridPlacement};
...
fn get_known_child_positions<'a>(
    children_iter: impl Iterator<Item = &'a FlexboxLayout>,
    ...
    children_iter.for_each(|child_style: &FlexboxLayout| {
...
mod tests {
    ...
    mod test_intial_grid_sizing {
        ...
        trait CreateChildTestNode {
            fn into_grid_child(&self) -> FlexboxLayout;
        }
