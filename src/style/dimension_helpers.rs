//! Helper functions to easily create styles and traits/impls to support them

use super::dimension::{Dimension, LengthPercentage, LengthPercentageAuto};
